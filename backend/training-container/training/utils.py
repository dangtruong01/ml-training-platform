...
def upload_results(task_id: str, model_dir: str, results: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        for root, dirs, files in os.walk(model_dir):
            for file in files:
                ...
                # Create cloud storage path with organized structure
                relative_path = os.path.relpath(local_file_path, model_dir)
                cloud_path = f"{model_type}/{task_id}/{relative_path}"
