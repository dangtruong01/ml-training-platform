...
def main(data_config, epochs=10, imgsz=640, project=None, name="yolo_detection_model", device="cpu"):
    """
    ...
    try:
        ...
        model_path = "yolov8n.pt"  # Start with nano model for faster training
        ...
        print(f"🔥 Starting training with parameters: {train_kwargs}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", type=str, default="yolo_detection_model", help="Name for this training run")
